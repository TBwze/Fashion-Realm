...
<div class="container mt-5">
    ...
    <div class="container-fluid d-flex flex-column mb-5">
        ...
        <a class="container-fluid d-flex border border-black bg-dark-subtle pe-0 mb-5 text-decoration-none" href="{{ url('product/' . $product->id) }}">
            <img src="{{ asset($product->image_front) }}" class="w-25 h-25 object-fit-contain" />
            ...
            <div class="w-25 d-flex justify-content-evenly align-items-center">
                <button class="btn btn-primary text-white fs-5" href="{{url('product/' . $product->id . '/edit')}}">Edit</button>
